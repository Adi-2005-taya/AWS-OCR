...
# Replace container
html = html.replace('<div id="floating-lines-container"', '<div id="hyperspeed-container"')

# Truncate old scripts
...
const DEFAULT_EFFECT_OPTIONS = {
  ...
  roadWidth: 10,
  islandWidth: 2,
  lanesPerRoad: 3, // updated from usage example
  fov: 90,
  fovSpeedUp: 150,
  speedUp: 2,
  carLightsFade: 0.4,

...
splash_html = '''
<canvas id="fluid" style="position: fixed; top: 0; left: 0; z-index: 50; pointer-events: none; width: 100vw; height: 100vh; display: block;"></canvas>
<script>
(function() {
...
def process_file(filepath):
    ...
    # We previously had WebGL removed, but we might have old bg-grid or aurora. We can keep them or put the fluid on top. 
    # Let's just insert the splash_html right before </body>
    if "id=\"fluid\"" not in html:
        html = html.replace('</body>', f'{splash_html}\\n</body>')
...
print('Done injecting SplashCursor!')
